...
# Adding a runtime dependency that brings a new root means adding that root here, but only when it is a genuine
# dependency of the shipped package -- the walks below are never widened just to make the test pass.
